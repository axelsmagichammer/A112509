...
\textit{Why $M\ge n/2$.}
$M=n-(k-1)\ge n-k$. Since $k\le\sqrt{n}/4$ we have $k\le n/(4\sqrt{n})=\sqrt{n}/4\le n/2$ for $n\ge1$, so $M\ge n-n/2=n/2$.
More explicitly: $k\le\sqrt{n}/4$ implies $k-1<\sqrt{n}/4\le n/2$ for $n\ge1$, hence $M=n-(k-1)>n/2$.
